...
<body>
  <div class="sidebar">
    ...
    <ul class="nav-list">
      ...
      <li>
        <a href="admin_academicResources_honesty.php" class="active">
  ...
  <section class="home-section">
    <div class="text">Edit Week Files - Honesty</div>
      <?php
      if ($results) {
        ...
        if (isset($_POST["btn_save"])) {
          ...
          if (mysqli_query($conn, $query)) {
            echo "<script> alert('File updated successfully.'); location.replace('./admin_academicResources_honesty.php') </script>";
          } else {

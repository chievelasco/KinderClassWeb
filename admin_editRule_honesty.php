          ...
          ?>
            <form action=" " method="post" class="editRuleContainer">
                  ...
                  <div class="col-6 m-auto ">
                    <button type="submit" name="insertEditRule" class="insertEditRule"><a href="admin_home_honesty.php">Save</a></button>
                    <button type="submit" name="insertEditRule" class="insertEditRule"><a href="admin_home_honesty.php">Cancel</a></button>
                  </div>
            </form>

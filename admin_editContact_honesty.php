            ...
            <h2>Edit Contact</h2>
                ...
                <input type="text" id="" name="contactInfo" value="<?php echo $contactInfo?>">
                  <div class="col-6 m-auto ">
                    <button type="submit" name="insertEditContact" class="insertEditContact"><a href="admin_home_honesty.php" style="color: #297582;">Save</a></button>
                    <button  class="insertEditContact"><a href="admin_home_honesty.php" style="color: #297582;">Cancel</a></button>
                  </div>
          </form>

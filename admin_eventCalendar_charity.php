...
<body class="background">
    <nav class="navbar navbar-expand-lg" style="background-color:#297582;" id="topNavBar">
        <div class="container">
        <a href="admin_home_charity.php"><button class="back-btn" ><h5><i class="fa fa-home"></i>  Back to Home</h5></button></a>
    ...
    <!-- Event Details Modal -->
        ...
        $schedules = $conn->query("SELECT * FROM `schedule_list` WHERE section='Charity' ");
        $sched_res = [];

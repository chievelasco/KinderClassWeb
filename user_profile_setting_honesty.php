...
if (isset($_POST["edit-save"])) {
  ...
  if ($updateResult) {
    header("Location: user_profile_setting_honesty.php");
    } else {
...
<body>
  ...
  <div class="navbottom">
    ...
    <ul class="navmenu">
      ...
      <li>
        <a href="user_profile_setting_honesty.php" class="active">
          ...
          <div class="col-lg-4">
            ...
            <div class="card-header bg-transparent text-center">
              ...
              <div class="card-body">
                ...
                <input type="button" onclick="studentEdit()" name="btn-edit" class="btn-edit" id="btn-edit" onmouseover="mouseover()" onmouseout="mouseout()"
                  value="Edit Profile"
    ...
    <div class="edit-modal" id="my-editmodal" name="modal-edit" style="display: none;">
      <div class="edit-content">
        <div class="edit-header">
          ...
          <h4><i class="fa fa-address-card-o" style="margin-right: 5px;"></i>Edit Guardian Profile</h4>
        </div>
        <div class="edit-body">
          <form class="edit-form" method="POST">

            <label for="gname">Full Name:</label><br>
            <input type="text" id="fname" name="gname" placeholder=""><br>

            <label for="relationship">Relation to student:</label><br>
...
<!-- epal here -->
    <div class="edit-modal" id="student-editmodal" name="modal-edit" style="display: none;">
      <div class="edit-content">
        <div class="edit-header">
          <span class="close" id="close" onclick="studentClose()">&times;</span>
          <h4><i class="fa fa-address-card-o" style="margin-right: 5px;"></i>Edit Guardian Profile</h4>
        </div>
        <div class="edit-body">
          <form class="edit-form" method="POST">
            ...
            <input type="text" id="section" name="section" placeholder=""><br>

            <label for="gender">Gender:</label><br>
            <input type="text" id="gender" name="gender" placeholder=""><br>

            <label for="birthday">Birthday:</label><br>
            <input type="date" id="birthday" name="birthday" placeholder=""><br>

            <label for="hcondition">Health Conditon:</label><br>
            <!-- <input type="text" id="hcondition" name="hcondition" placeholder=""><br> -->
            ...
            <input type="submit" id="edit-save" name="student-save" class="edit-save" value="Save">
          </form>
        </div>
      </div>
  ...
  <div class="edit-modal" id="my-profile-pic-modal" name="modal-profile-pic" style="display: none;">
    ...
    <script>
      function studentEdit() {
        document.getElementById('student-editmodal').style.display = 'block';
      }

      function studentClose() {
        document.getElementById('student-editmodal').style.display = 'none';
      }
      function mouseover() {
        document.getElementById('btn-edit').style.background = "#297582";
        document.getElementById('btn-edit').style.color = "#fff";
